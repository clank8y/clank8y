...
function buildReviewBody(rawBody: string | undefined): string {
  ...
  return [
    ...
    '',
    '> [!WARNING]',
    '> This review was generated by a bot and may include inaccuracies.',
    '',
    `<p align="right"><a href="${clank8yRepoUrl}">clank8y</a> is a PR review bot for <a href="${cumulocityUrl}">Cumulocity</a> applications</p>`,
  ].join('\n')
}
