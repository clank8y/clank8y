...
- When installing `@github/copilot` globally for the Copilot agent, pin the global CLI to the version required by the installed `@github/copilot-sdk` package so their protocol versions stay aligned.
